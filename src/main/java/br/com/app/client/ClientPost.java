...
//        System.out.println(output);
    ...
    public static String postChoices(int idQuest, int idChoice) {
        ...
        return polls(url, null, token.getAccess_token());
    }
    ...
    public static String postNewQuestion(String strQuestion, String... strchoices) {
        ...
        return polls(url, param, token.getAccess_token());
    }
...
//        String param = "{\"qty\":100,\"name\":\"iPad 4\"}";
        ...
        return polls(url, param, null);
    }

    private static String polls(String urlPOST, String input, String token) {
